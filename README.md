...
The data was used from the official website of DBLP <a href="https://dblp.org/faq/16154937.html"></href>.The dataset was in the XML format, hence was needed to convert to CSV format for loading into Neo4j. The CSV files were generated by running the below command :
